...
GrB_Info LAGraph_alloc_global ( )
{
    ...
    LAGRAPH_OK (GrB_BinaryOp_new (&LAGraph_EQ_Complex, LAGraph_eq_complex,
        GrB_BOOL, LAGraph_Complex, LAGraph_Complex)) ;

    LAGRAPH_OK (GrB_BinaryOp_new (&LAGraph_SKEW_INT8, LAGraph_skew_int8,
        GrB_BOOL, GrB_INT8, GrB_INT8)) ;

    LAGRAPH_OK (GrB_BinaryOp_new (&LAGraph_SKEW_INT16, LAGraph_skew_int16,
        GrB_BOOL, GrB_INT16, GrB_INT16)) ;

    LAGRAPH_OK (GrB_BinaryOp_new (&LAGraph_SKEW_INT32, LAGraph_skew_int32,
        GrB_BOOL, GrB_INT32, GrB_INT32)) ;

    LAGRAPH_OK (GrB_BinaryOp_new (&LAGraph_SKEW_INT64, LAGraph_skew_int64,
        GrB_BOOL, GrB_INT64, GrB_INT64)) ;

    LAGRAPH_OK (GrB_BinaryOp_new (&LAGraph_SKEW_FP32, LAGraph_skew_float,
        GrB_BOOL, GrB_FP32, GrB_FP32)) ;

    LAGRAPH_OK (GrB_BinaryOp_new (&LAGraph_SKEW_FP64, LAGraph_skew_double,
        GrB_BOOL, GrB_FP64, GrB_FP64)) ;

    LAGRAPH_OK (GrB_BinaryOp_new (&LAGraph_SKEW_Complex, LAGraph_skew_complex,
        GrB_BOOL, LAGraph_Complex, LAGraph_Complex)) ;

    LAGRAPH_OK (GrB_BinaryOp_new (&LAGraph_Hermitian, LAGraph_hermitian,
        GrB_BOOL, LAGraph_Complex, LAGraph_Complex)) ;

    // create the unary operators

    LAGRAPH_OK (GrB_UnaryOp_new (&LAGraph_ISONE_INT8, LAGraph_isone_int8,
        GrB_BOOL, GrB_INT8)) ;

    LAGRAPH_OK (GrB_UnaryOp_new (&LAGraph_ISONE_INT16, LAGraph_isone_int16,
        GrB_BOOL, GrB_INT16)) ;

    LAGRAPH_OK (GrB_UnaryOp_new (&LAGraph_ISONE_INT32, LAGraph_isone_int32,
        GrB_BOOL, GrB_INT32)) ;

    LAGRAPH_OK (GrB_UnaryOp_new (&LAGraph_ISONE_INT64, LAGraph_isone_int64,
        GrB_BOOL, GrB_INT64)) ;

    LAGRAPH_OK (GrB_UnaryOp_new (&LAGraph_ISONE_UINT8, LAGraph_isone_uint8,
        GrB_BOOL, GrB_UINT8)) ;

    LAGRAPH_OK (GrB_UnaryOp_new (&LAGraph_ISONE_UINT16, LAGraph_isone_uint16,
        GrB_BOOL, GrB_UINT16)) ;

    LAGRAPH_OK (GrB_UnaryOp_new (&LAGraph_ISONE_UINT32, LAGraph_isone_uint32,
        GrB_BOOL, GrB_UINT32)) ;

    LAGRAPH_OK (GrB_UnaryOp_new (&LAGraph_ISONE_UINT64, LAGraph_isone_uint64,
        GrB_BOOL, GrB_UINT64)) ;

    LAGRAPH_OK (GrB_UnaryOp_new (&LAGraph_ISONE_UINT64, LAGraph_isone_float,
        GrB_BOOL, GrB_FP32)) ;

    LAGRAPH_OK (GrB_UnaryOp_new (&LAGraph_ISONE_UINT64, LAGraph_isone_double,
        GrB_BOOL, GrB_FP64)) ;
