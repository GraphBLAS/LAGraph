...
// LAGraph_Vector_isequal: check if two vectors are identically equal (same size,
...
)
{
    ...
    if (result == NULL)
    {
        ...
        printf ("LAGraph_Vector_isequal: bad args\n") ;
    ...
    {
        // types differ
        // printf ("LAGraph_Vector_isequal: types differ\n") ;
        return (GrB_SUCCESS) ;
    }
