...
GrB_BinaryOp LAGraph_FIRST_Complex = NULL, LAGraph_SECOND_Complex = NULL, LAGraph_MIN_Complex = NULL,
             LAGraph_MAX_Complex   = NULL, LAGraph_PLUS_Complex   = NULL, LAGraph_MINUS_Complex = NULL,
             LAGraph_TIMES_Complex = NULL, LAGraph_DIV_Complex    = NULL, LAGraph_RMINUS_Complex = NULL,
...
GrB_BinaryOp LAGraph_ISEQ_Complex = NULL, LAGraph_ISNE_Complex = NULL,
             LAGraph_ISGT_Complex = NULL, LAGraph_ISLT_Complex = NULL,
             LAGraph_ISGE_Complex = NULL, LAGraph_ISLE_Complex = NULL ;
...
GrB_BinaryOp LAGraph_OR_Complex = NULL, LAGraph_AND_Complex = NULL, LAGraph_XOR_Complex = NULL ;
...
GrB_BinaryOp LAGraph_EQ_Complex = NULL, LAGraph_NE_Complex = NULL,
             LAGraph_GT_Complex = NULL, LAGraph_LT_Complex = NULL,
             LAGraph_GE_Complex = NULL, LAGraph_LE_Complex = NULL ;
...
GrB_UnaryOp  LAGraph_IDENTITY_Complex = NULL, LAGraph_AINV_Complex = NULL, LAGraph_MINV_Complex = NULL,
             LAGraph_NOT_Complex = NULL,      LAGraph_CONJ_Complex = NULL,
             LAGraph_ONE_Complex = NULL,      LAGraph_ABS_Complex  = NULL ;
...
GrB_UnaryOp LAGraph_REAL_Complex = NULL, LAGraph_IMAG_Complex = NULL,
            LAGraph_CABS_Complex = NULL, LAGraph_ANGLE_Complex = NULL ;
...
GrB_UnaryOp LAGraph_COMPLEX_REAL_Complex = NULL, LAGraph_COMPLEX_IMAG_Complex = NULL ;

//------------------------------------------------------------------------------
// Complex type, scalars, monoids, and semiring
//------------------------------------------------------------------------------

GrB_Monoid   LAGraph_PLUS_Complex_MONOID = NULL, LAGraph_TIMES_Complex_MONOID = NULL ;
