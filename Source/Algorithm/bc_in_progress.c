...
//      LAGRAPH_OK (GrB_eWiseAdd(paths, GrB_NULL, GrB_NULL, GxB_PLUS_TIMES_INT64, paths, frontier, GrB_NULL));
        ...
        // paths (:,:) += frontier
        LAGRAPH_OK (GrB_assign (paths, GrB_NULL, GrB_PLUS_INT64, frontier,
            GrB_ALL, n, GrB_ALL, num_sources, GrB_NULL)) ;
    ...
    LAGRAPH_OK (GrB_apply(inv_paths, paths, GrB_NULL, GrB_MINV_FP64, paths, GrB_NULL));
