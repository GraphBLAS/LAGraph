//------------------------------------------------------------------------------
// LAGraph_pagerank3: pagerank using a real semiring
//------------------------------------------------------------------------------
...
// LAGraph_pagerank3: Alternative PageRank implementation using a real
// semiring.
//
...
GrB_Info LAGraph_pagerank3 // PageRank definition
(
...
)
{
    ...
    for (int i = 0; i < itermax; i++)
    {
        ...
        //pr = teleport[_scalar] + importance_vec
    }
