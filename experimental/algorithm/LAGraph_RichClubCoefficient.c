...
)
{
    ...
    *vpd_arr = NULL;
    ...
    GRB_TRY (GxB_BinaryOp_new(
        ...
        GrB_INT64, GrB_INT64, GrB_INT64, "LG_RCC_iseq_2islt", LG_RCC_iseq_2islt_JIT_STR)) ;
    GRB_TRY (GxB_BinaryOp_new(
