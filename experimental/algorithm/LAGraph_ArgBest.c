...
)
{
    ...
    int fmt ;
    GRB_TRY (GrB_Matrix_get_INT32 (A, &fmt, GxB_FORMAT)) ;
    ...
    if (A_type == GrB_BOOL)
    {
        ...
        GRB_TRY (GxB_Type_new (&Tuple, sizeof (tuple_bool), "tuple_bool", BOOL_K)) ;
        GRB_TRY (GxB_IndexBinaryOp_new (&Iop,
        ...
        {
            id.v = true ;
            GRB_TRY (GxB_BinaryOp_new (&MonOp, (GxB_binary_function) min_bool,
                Tuple, Tuple, Tuple, "min_bool", MIN_BOOL)) ;
        }
        else
        {
            id.v = false ;
            GRB_TRY (GxB_BinaryOp_new (&MonOp, (GxB_binary_function) max_bool,
                Tuple, Tuple, Tuple, "max_bool", MAX_BOOL)) ;
        }
        GRB_TRY (GrB_Monoid_new_UDT (&Monoid, MonOp, &id)) ;
        GRB_TRY (GrB_Semiring_new (&Semiring, Monoid, Bop)) ;
        if (dim == 0)
        {
            GRB_TRY (GxB_Type_new (&Tuple3, sizeof (tuple3_bool),
                "tuple3_bool", BOOL_IJ)) ;
            if (fmt == GxB_BY_ROW)
            {
                GRB_TRY (GxB_IndexUnaryOp_new (&Make3,
            ...
            {
                id3.v = true ;
                GRB_TRY (GxB_BinaryOp_new (&Mon3Op, (GxB_binary_function) min3_bool,
                    Tuple3, Tuple3, Tuple3, "min3_bool", MIN3_BOOL)) ;
            }
            else
            {
                id3.v = false ;
                GRB_TRY (GxB_BinaryOp_new (&Mon3Op, (GxB_binary_function) max3_bool,
                    Tuple3, Tuple3, Tuple3, "max3_bool", MAX3_BOOL)) ;
            }
            GRB_TRY (GrB_Monoid_new_UDT (&Monoid3, Mon3Op, &id3)) ;
        }
        else
        {
            GRB_TRY (GxB_UnaryOp_new (&Getk, (GxB_unary_function) getk_bool,
                GrB_INT64, Tuple, "getk_bool", GETK_BOOL)) ;
            GRB_TRY (GxB_UnaryOp_new (&Getv, (GxB_unary_function) getv_bool,
    ...
    else if (A_type == GrB_INT8)
    {
        ...
        GRB_TRY (GxB_Type_new (&Tuple, sizeof (tuple_int8), "tuple_int8", INT8_K)) ;
        GRB_TRY (GxB_IndexBinaryOp_new (&Iop,
        ...
        {
            id.v = INT8_MAX ;
            GRB_TRY (GxB_BinaryOp_new (&MonOp, (GxB_binary_function) min_int8,
                Tuple, Tuple, Tuple, "min_int8", MIN_INT8)) ;
        }
        else
        {
            id.v = INT8_MIN ;
            GRB_TRY (GxB_BinaryOp_new (&MonOp, (GxB_binary_function) max_int8,
        ...
        if (dim == 0)
        {
            GRB_TRY (GxB_Type_new (&Tuple3, sizeof (tuple3_int8),
                "tuple3_int8", INT8_IJ)) ;
            if (fmt == GxB_BY_ROW)
            {
                GRB_TRY (GxB_IndexUnaryOp_new (&Make3,
            ...
            {
                id3.v = INT8_MAX ;
                GRB_TRY (GxB_BinaryOp_new (&Mon3Op, (GxB_binary_function) min3_int8,
                    Tuple3, Tuple3, Tuple3, "min3_int8", MIN3_INT8)) ;
            }
            else
            {
                id3.v = INT8_MIN ;
                GRB_TRY (GxB_BinaryOp_new (&Mon3Op, (GxB_binary_function) max3_int8,
        ...
        {
            GRB_TRY (GxB_UnaryOp_new (&Getk, (GxB_unary_function) getk_int8,
                GrB_INT64, Tuple, "getk_int8", GETK_INT8)) ;
            GRB_TRY (GxB_UnaryOp_new (&Getv, (GxB_unary_function) getv_int8,
    ...
    else if (A_type == GrB_INT16)
    {
        ...
        GRB_TRY (GxB_Type_new (&Tuple, sizeof (tuple_int16),
            "tuple_int16", INT16_K)) ;
        GRB_TRY (GxB_IndexBinaryOp_new (&Iop,
        ...
        {
            id.v = INT16_MAX ;
            GRB_TRY (GxB_BinaryOp_new (&MonOp, (GxB_binary_function) min_int16,
                Tuple, Tuple, Tuple, "min_int16", MIN_INT16)) ;
        }
        else
        {
            id.v = INT16_MIN ;
            GRB_TRY (GxB_BinaryOp_new (&MonOp, (GxB_binary_function) max_int16,
        ...
        if (dim == 0)
        {
            GRB_TRY (GxB_Type_new (&Tuple3, sizeof (tuple3_int16),
            ...
            {
                id3.v = INT16_MAX ;
                GRB_TRY (GxB_BinaryOp_new (&Mon3Op, (GxB_binary_function) min3_int16,
                    Tuple3, Tuple3, Tuple3, "min3_int16", MIN3_INT16)) ;
            }
            else
            {
                id3.v = INT16_MIN ;
                GRB_TRY (GxB_BinaryOp_new (&Mon3Op, (GxB_binary_function) max3_int16,
        ...
        {
            GRB_TRY (GxB_UnaryOp_new (&Getk, (GxB_unary_function) getk_int16,
                GrB_INT64, Tuple, "getk_int16", GETK_INT16)) ;
            GRB_TRY (GxB_UnaryOp_new (&Getv, (GxB_unary_function) getv_int16,
    ...
    else if (A_type == GrB_INT32)
    {
        ...
        GRB_TRY (GxB_Type_new (&Tuple, sizeof (tuple_int32),
            "tuple_int32", INT32_K)) ;
        GRB_TRY (GxB_IndexBinaryOp_new (&Iop,
        ...
        {
            id.v = INT32_MAX ;
            GRB_TRY (GxB_BinaryOp_new (&MonOp, (GxB_binary_function) min_int32,
                Tuple, Tuple, Tuple, "min_int32", MIN_INT32)) ;
        }
        else
        {
            id.v = INT32_MIN ;
            GRB_TRY (GxB_BinaryOp_new (&MonOp, (GxB_binary_function) max_int32,
        ...
        if (dim == 0)
        {
            GRB_TRY (GxB_Type_new (&Tuple3, sizeof (tuple3_int32),
            ...
            {
                id3.v = INT32_MAX ;
                GRB_TRY (GxB_BinaryOp_new (&Mon3Op, (GxB_binary_function) min3_int32,
                    Tuple3, Tuple3, Tuple3, "min3_int32", MIN3_INT32)) ;
            }
            else
            {
                id3.v = INT32_MIN ;
                GRB_TRY (GxB_BinaryOp_new (&Mon3Op, (GxB_binary_function) max3_int32,
        ...
        {
            GRB_TRY (GxB_UnaryOp_new (&Getk, (GxB_unary_function) getk_int32,
                GrB_INT64, Tuple, "getk_int32", GETK_INT32)) ;
            GRB_TRY (GxB_UnaryOp_new (&Getv, (GxB_unary_function) getv_int32,
    ...
    else if (A_type == GrB_INT64)
    {
        ...
        GRB_TRY (GxB_Type_new (&Tuple, sizeof (tuple_int64),
            "tuple_int64", INT64_K)) ;
        GRB_TRY (GxB_IndexBinaryOp_new (&Iop,
        ...
        {
            id.v = INT64_MAX ;
            GRB_TRY (GxB_BinaryOp_new (&MonOp, (GxB_binary_function) min_int64,
                Tuple, Tuple, Tuple, "min_int64", MIN_INT64)) ;
        }
        else
        {
            id.v = INT64_MIN ;
            GRB_TRY (GxB_BinaryOp_new (&MonOp, (GxB_binary_function) max_int64,
        ...
        if (dim == 0)
        {
            GRB_TRY (GxB_Type_new (&Tuple3, sizeof (tuple3_int64),
            ...
            {
                id3.v = INT64_MAX ;
                GRB_TRY (GxB_BinaryOp_new (&Mon3Op, (GxB_binary_function) min3_int64,
                    Tuple3, Tuple3, Tuple3, "min3_int64", MIN3_INT64)) ;
            }
            else
            {
                id3.v = INT64_MIN ;
                GRB_TRY (GxB_BinaryOp_new (&Mon3Op, (GxB_binary_function) max3_int64,
        ...
        {
            GRB_TRY (GxB_UnaryOp_new (&Getk, (GxB_unary_function) getk_int64,
                GrB_INT64, Tuple, "getk_int64", GETK_INT64)) ;
            GRB_TRY (GxB_UnaryOp_new (&Getv, (GxB_unary_function) getv_int64,
    ...
    else if (A_type == GrB_UINT8)
    {
        ...
        GRB_TRY (GxB_Type_new (&Tuple, sizeof (tuple_uint8),
            "tuple_uint8", UINT8_K)) ;
        GRB_TRY (GxB_IndexBinaryOp_new (&Iop,
        ...
        {
            id.v = UINT8_MAX ;
            GRB_TRY (GxB_BinaryOp_new (&MonOp, (GxB_binary_function) min_uint8,
                Tuple, Tuple, Tuple, "min_uint8", MIN_UINT8)) ;
        }
        else
        {
            id.v = 0 ;
            GRB_TRY (GxB_BinaryOp_new (&MonOp, (GxB_binary_function) max_uint8,
        ...
        if (dim == 0)
        {
            GRB_TRY (GxB_Type_new (&Tuple3, sizeof (tuple3_uint8),
            ...
            {
                id3.v = UINT8_MAX ;
                GRB_TRY (GxB_BinaryOp_new (&Mon3Op, (GxB_binary_function) min3_uint8,
                    Tuple3, Tuple3, Tuple3, "min3_uint8", MIN3_UINT8)) ;
            }
            else
            {
                id3.v = 0 ;
                GRB_TRY (GxB_BinaryOp_new (&Mon3Op, (GxB_binary_function) max3_uint8,
        ...
        {
            GRB_TRY (GxB_UnaryOp_new (&Getk, (GxB_unary_function) getk_uint8,
                GrB_INT64, Tuple, "getk_uint8", GETK_UINT8)) ;
            GRB_TRY (GxB_UnaryOp_new (&Getv, (GxB_unary_function) getv_uint8,
    ...
    else if (A_type == GrB_UINT16)
    {
        ...
        GRB_TRY (GxB_Type_new (&Tuple, sizeof (tuple_uint16),
        ...
        {
            id.v = UINT16_MAX ;
            GRB_TRY (GxB_BinaryOp_new (&MonOp, (GxB_binary_function) min_uint16,
                Tuple, Tuple, Tuple, "min_uint16", MIN_UINT16)) ;
        }
        else
        {
            id.v = 0 ;
            GRB_TRY (GxB_BinaryOp_new (&MonOp, (GxB_binary_function) max_uint16,
        ...
        if (dim == 0)
        {
            GRB_TRY (GxB_Type_new (&Tuple3, sizeof (tuple3_uint16),
            ...
            {
                id3.v = UINT16_MAX ;
                GRB_TRY (GxB_BinaryOp_new (&Mon3Op, (GxB_binary_function)min3_uint16,
                    Tuple3, Tuple3, Tuple3, "min3_uint16", MIN3_UINT16)) ;
            }
            else
            {
                id3.v = 0 ;
                GRB_TRY (GxB_BinaryOp_new (&Mon3Op, (GxB_binary_function)max3_uint16,
        ...
        {
            GRB_TRY (GxB_UnaryOp_new (&Getk, (GxB_unary_function) getk_uint16,
                GrB_INT64, Tuple, "getk_uint16", GETK_UINT16)) ;
            GRB_TRY (GxB_UnaryOp_new (&Getv, (GxB_unary_function) getv_uint16,
    ...
    else if (A_type == GrB_UINT32)
    {
        ...
        GRB_TRY (GxB_Type_new (&Tuple, sizeof (tuple_uint32),
        ...
        {
            id.v = UINT32_MAX ;
            GRB_TRY (GxB_BinaryOp_new (&MonOp, (GxB_binary_function) min_uint32,
                Tuple, Tuple, Tuple, "min_uint32", MIN_UINT32)) ;
        }
        else
        {
            id.v = 0 ;
            GRB_TRY (GxB_BinaryOp_new (&MonOp, (GxB_binary_function) max_uint32,
        ...
        if (dim == 0)
        {
            GRB_TRY (GxB_Type_new (&Tuple3, sizeof (tuple3_uint32),
            ...
            {
                id3.v = UINT32_MAX ;
                GRB_TRY (GxB_BinaryOp_new (&Mon3Op, (GxB_binary_function)min3_uint32,
                    Tuple3, Tuple3, Tuple3, "min3_uint32", MIN3_UINT32)) ;
            }
            else
            {
                id3.v = 0 ;
                GRB_TRY (GxB_BinaryOp_new (&Mon3Op, (GxB_binary_function)max3_uint32,
        ...
        {
            GRB_TRY (GxB_UnaryOp_new (&Getk, (GxB_unary_function) getk_uint32,
                GrB_INT64, Tuple, "getk_uint32", GETK_UINT32)) ;
            GRB_TRY (GxB_UnaryOp_new (&Getv, (GxB_unary_function) getv_uint32,
    ...
    else if (A_type == GrB_UINT64)
    {
        ...
        GRB_TRY (GxB_Type_new (&Tuple, sizeof (tuple_uint64),
        ...
        {
            id.v = UINT64_MAX ;
            GRB_TRY (GxB_BinaryOp_new (&MonOp, (GxB_binary_function) min_uint64,
                Tuple, Tuple, Tuple, "min_uint64", MIN_UINT64)) ;
        }
        else
        {
            id.v = 0 ;
            GRB_TRY (GxB_BinaryOp_new (&MonOp, (GxB_binary_function) max_uint64,
        ...
        if (dim == 0)
        {
            GRB_TRY (GxB_Type_new (&Tuple3, sizeof (tuple3_uint64),
            ...
            {
                id3.v = UINT64_MAX ;
                GRB_TRY (GxB_BinaryOp_new (&Mon3Op, (GxB_binary_function)min3_uint64,
                    Tuple3, Tuple3, Tuple3, "min3_uint64", MIN3_UINT64)) ;
            }
            else
            {
                id3.v = 0 ;
                GRB_TRY (GxB_BinaryOp_new (&Mon3Op, (GxB_binary_function)max3_uint64,
        ...
        {
            GRB_TRY (GxB_UnaryOp_new (&Getk, (GxB_unary_function) getk_uint64,
                GrB_INT64, Tuple, "getk_uint64", GETK_UINT64)) ;
            GRB_TRY (GxB_UnaryOp_new (&Getv, (GxB_unary_function) getv_uint64,
    ...
    else if (A_type == GrB_FP32)
    {
        ...
        GRB_TRY (GxB_Type_new (&Tuple, sizeof (tuple_fp32), "tuple_fp32", FP32_K)) ;
        GRB_TRY (GxB_IndexBinaryOp_new (&Iop,
        ...
        {
            id.v = (float) INFINITY ;
            GRB_TRY (GxB_BinaryOp_new (&MonOp, (GxB_binary_function) min_fp32,
                Tuple, Tuple, Tuple, "min_fp32", MIN_FP32)) ;
        }
        else
        {
            id.v = (float) (-INFINITY) ;
            GRB_TRY (GxB_BinaryOp_new (&MonOp, (GxB_binary_function) max_fp32,
        ...
        if (dim == 0)
        {
            GRB_TRY (GxB_Type_new (&Tuple3, sizeof (tuple3_fp32),
                "tuple3_fp32", FP32_IJ)) ;
            if (fmt == GxB_BY_ROW)
            {
                GRB_TRY (GxB_IndexUnaryOp_new (&Make3,
            ...
            if (is_min)
            {
                ...
                GRB_TRY (GxB_BinaryOp_new (&Mon3Op, (GxB_binary_function) min3_fp32,
                    Tuple3, Tuple3, Tuple3, "min3_fp32", MIN3_FP32)) ;
            }
            else
            {
                id3.v = (float) (-INFINITY) ;
                GRB_TRY (GxB_BinaryOp_new (&Mon3Op, (GxB_binary_function) max3_fp32,
        ...
        {
            GRB_TRY (GxB_UnaryOp_new (&Getk, (GxB_unary_function) getk_fp32,
                GrB_INT64, Tuple, "getk_fp32", GETK_FP32)) ;
            GRB_TRY (GxB_UnaryOp_new (&Getv, (GxB_unary_function) getv_fp32,
    ...
    else if (A_type == GrB_FP64)
    {
        ...
        if (is_min)
        {
            ...
            GRB_TRY (GxB_BinaryOp_new (&MonOp, (GxB_binary_function) min_fp64,
                Tuple, Tuple, Tuple, "min_fp64", MIN_FP64)) ;
        }
        else
        {
            id.v = (double) (-INFINITY) ;
            GRB_TRY (GxB_BinaryOp_new (&MonOp, (GxB_binary_function) max_fp64,
        ...
        if (dim == 0)
        {
            GRB_TRY (GxB_Type_new (&Tuple3, sizeof (tuple3_fp64),
                "tuple3_fp64", FP64_IJ)) ;
            if (fmt == GxB_BY_ROW)
            {
                GRB_TRY (GxB_IndexUnaryOp_new (&Make3,
            ...
            if (is_min)
            {
                ...
                GRB_TRY (GxB_BinaryOp_new (&Mon3Op, (GxB_binary_function) min3_fp64,
                    Tuple3, Tuple3, Tuple3, "min3_fp64", MIN3_FP64)) ;
            }
            else
            {
                id3.v = (double) (-INFINITY) ;
                GRB_TRY (GxB_BinaryOp_new (&Mon3Op, (GxB_binary_function) max3_fp64,
        ...
        {
            GRB_TRY (GxB_UnaryOp_new (&Getk, (GxB_unary_function) getk_fp64,
                GrB_INT64, Tuple, "getk_fp64", GETK_FP64)) ;
            GRB_TRY (GxB_UnaryOp_new (&Getv, (GxB_unary_function) getv_fp64,
    ...
    if (dim == 0)
    {
        ...
        if (fmt == GxB_BY_ROW)
        {
            // A is held by row
            // y = zeros (ncols,1) ;
            GRB_TRY (GrB_Matrix_new (&y, GrB_BOOL, ncols, 1)) ;
            GRB_TRY (GrB_Matrix_assign_BOOL (y, NULL, NULL, 0,
                GrB_ALL, ncols, GrB_ALL, 1, NULL)) ;

            // c = A*y using the argmin/argmax semiring
            GRB_TRY (GrB_Matrix_new (&c, Tuple, nrows, 1)) ;
            GRB_TRY (GrB_mxm (c, NULL, NULL, Semiring, A, y, NULL)) ;

            // create z
            GRB_TRY (GrB_Matrix_new (&z, Tuple3, nrows, 1)) ;
        }
        else
        {
            // A is held by column (the default for MATLAB)
            // y = zeros (nrows,1) ;
            GRB_TRY (GrB_Matrix_new (&y, GrB_BOOL, nrows, 1)) ;
            GRB_TRY (GrB_Matrix_assign_BOOL (y, NULL, NULL, 0,
                GrB_ALL, nrows, GrB_ALL, 1, NULL)) ;

            // c = A'*y using the argmin/argmax semiring
            GRB_TRY (GrB_Matrix_new (&c, Tuple, ncols, 1)) ;
            GRB_TRY (GrB_mxm (c, NULL, NULL, Semiring, A, y, GrB_DESC_T0)) ;

            // create z
            GRB_TRY (GrB_Matrix_new (&z, Tuple3, ncols, 1)) ;
        }

        // z = make3 (c)
        GRB_TRY (GrB_Matrix_apply_IndexOp_BOOL (z, NULL, NULL, Make3, c, 0, NULL)) ;

        // s = max3 (z)
        GRB_TRY (GrB_Scalar_new (&s, Tuple3)) ;
        GRB_TRY (GrB_Matrix_reduce_Monoid_Scalar (s, NULL, Monoid3, z, NULL)) ;

        // x = s.v, p = {s.i, s.j}
        GRB_TRY (GrB_Matrix_new (&x, A_type, 1, 1)) ;
        GRB_TRY (GrB_Matrix_new (&p, GrB_INT64, 2, 1)) ;
        GRB_TRY (GrB_Scalar_nvals (&nvals, s)) ;
        ...
        if (nvals > 0)
        {
            ...
            {
                tuple3_bool result ;
                GRB_TRY (GrB_Scalar_extractElement_UDT (&result, s)) ;
                GRB_TRY (GrB_Matrix_setElement_BOOL (x, result.v, 0, 0)) ;
                si = result.i ;
                sj = result.j ;
            }
            else if (A_type == GrB_INT8)
            {
                tuple3_int8 result ;
                GRB_TRY (GrB_Scalar_extractElement_UDT (&result, s)) ;
                GRB_TRY (GrB_Matrix_setElement_INT8 (x, result.v, 0, 0)) ;
                si = result.i ;
                sj = result.j ;
            }
            else if (A_type == GrB_INT16)
            {
                tuple3_int16 result ;
                GRB_TRY (GrB_Scalar_extractElement_UDT (&result, s)) ;
                GRB_TRY (GrB_Matrix_setElement_INT16 (x, result.v, 0, 0)) ;
                si = result.i ;
                sj = result.j ;
            }
            else if (A_type == GrB_INT32)
            {
                tuple3_int32 result ;
                GRB_TRY (GrB_Scalar_extractElement_UDT (&result, s)) ;
                GRB_TRY (GrB_Matrix_setElement_INT32 (x, result.v, 0, 0)) ;
                si = result.i ;
                sj = result.j ;
            }
            else if (A_type == GrB_INT64)
            {
                tuple3_int64 result ;
                GRB_TRY (GrB_Scalar_extractElement_UDT (&result, s)) ;
                GRB_TRY (GrB_Matrix_setElement_INT64 (x, result.v, 0, 0)) ;
                si = result.i ;
                sj = result.j ;
            }
            else if (A_type == GrB_UINT8)
            {
                tuple3_uint8 result ;
                GRB_TRY (GrB_Scalar_extractElement_UDT (&result, s)) ;
                GRB_TRY (GrB_Matrix_setElement_UINT8 (x, result.v, 0, 0)) ;
                si = result.i ;
                sj = result.j ;
            }
            else if (A_type == GrB_UINT16)
            {
                ...
                GRB_TRY (GrB_Scalar_extractElement_UDT (&result, s)) ;
                GRB_TRY (GrB_Matrix_setElement_UINT16 (x, result.v, 0, 0)) ;
                si = result.i ;
                sj = result.j ;
            }
            else if (A_type == GrB_UINT32)
            {
                ...
                GRB_TRY (GrB_Scalar_extractElement_UDT (&result, s)) ;
                GRB_TRY (GrB_Matrix_setElement_UINT32 (x, result.v, 0, 0)) ;
                si = result.i ;
                sj = result.j ;
            }
            else if (A_type == GrB_UINT64)
            {
                ...
                GRB_TRY (GrB_Scalar_extractElement_UDT (&result, s)) ;
                GRB_TRY (GrB_Matrix_setElement_UINT64 (x, result.v, 0, 0)) ;
                si = result.i ;
                sj = result.j ;
            }
            else if (A_type == GrB_FP32)
            {
                tuple3_fp32 result ;
                GRB_TRY (GrB_Scalar_extractElement_UDT (&result, s)) ;
                GRB_TRY (GrB_Matrix_setElement_FP32 (x, result.v, 0, 0)) ;
                si = result.i ;
                sj = result.j ;
            }
            else // if (A_type == GrB_FP64)
            {
                tuple3_fp64 result ;
                GRB_TRY (GrB_Scalar_extractElement_UDT (&result, s)) ;
                GRB_TRY (GrB_Matrix_setElement_FP64 (x, result.v, 0, 0)) ;
                si = result.i ;
                sj = result.j ;
            }
            GRB_TRY (GrB_Matrix_setElement_INT64 (p, si, 0, 0)) ;
            GRB_TRY (GrB_Matrix_setElement_INT64 (p, sj, 1, 0)) ;
        }
    ...
    else
    {
        ...
        if (dim == 1)
        {
            ...
            // create x and p
            GRB_TRY (GrB_Matrix_new (&x, A_type, ncols, 1)) ;
            GRB_TRY (GrB_Matrix_new (&p, GrB_INT64, ncols, 1)) ;
        ...
        else
        {
            ...
            // create x and p
            GRB_TRY (GrB_Matrix_new (&x, A_type, nrows, 1)) ;
            GRB_TRY (GrB_Matrix_new (&p, GrB_INT64, nrows, 1)) ;
        }

        // x = getv (c)
        GRB_TRY (GrB_Matrix_apply (x, NULL, NULL, Getv, c, NULL)) ;
        // p = getk (c)
        GRB_TRY (GrB_Matrix_apply (p, NULL, NULL, Getk, c, NULL)) ;
    }
    ...
    GRB_TRY (GrB_Type_free (&Tuple)) ;
    GRB_TRY (GrB_Type_free (&Tuple3)) ;
    GRB_TRY (GxB_IndexBinaryOp_free (&Iop)) ;
    GRB_TRY (GrB_IndexUnaryOp_free (&Make3)) ;
    GRB_TRY (GrB_BinaryOp_free (&Bop)) ;
    GRB_TRY (GrB_BinaryOp_free (&MonOp)) ;
    GRB_TRY (GrB_BinaryOp_free (&Mon3Op)) ;
    GRB_TRY (GrB_Monoid_free (&Monoid)) ;
    GRB_TRY (GrB_Monoid_free (&Monoid3)) ;
    GRB_TRY (GrB_Semiring_free (&Semiring)) ;
    GRB_TRY (GrB_UnaryOp_free (&Getv)) ;
    GRB_TRY (GrB_UnaryOp_free (&Getk)) ;
    GRB_TRY (GrB_Matrix_free (&y)) ;
    GRB_TRY (GrB_Matrix_free (&c)) ;
    GRB_TRY (GrB_Matrix_free (&A)) ;
    GRB_TRY (GrB_Matrix_free (&z)) ;
    GRB_TRY (GrB_Scalar_free (&Theta)) ;
    GRB_TRY (GrB_Scalar_free (&s)) ;

    GrB_Index m ;
    GRB_TRY (GrB_Matrix_nrows (&m, x)) ;
    GRB_TRY (GrB_Vector_new (x_result, A_type, m)) ;
