//------------------------------------------------------------------------------
// LG_check_malloc: brutal memory debugging
//------------------------------------------------------------------------------
...
// allocations will occur, and LG_check_malloc, etc, all pretend to fail
// and return NULL.

// If LG_brutal is negative, the LG_check_malloc/calloc/realloc functions act
...
// LG_check_malloc/calloc and by LG_check_realloc if a new block is allocated.
// It is decremented by LG_check_free.  After LAGraph_Finalize is called,
...
)
{
    ...
    {
        // malloc a new block
        #pragma omp critical (LG_check_malloc_critical)
        {
